describe('Проверка авторизации', function () {
    ...
    it('Верный пароль и верный логин', function () {
     ...
     it('Проверка восстановление пароля', function () {
        ...
        cy.get('#mailForgot').type('german@dolnikov.ru'); // Ввели почту для вос.
    ...
    it('Неверный логин и верный пароль', function () {
        ...
        cy.get('#mail').type('germani@dolnikov.ru'); // Ввели неверный логин
        cy.get('#pass').type('iLoveqastudio1'); // Ввели верный пароль
        cy.get('#loginButton').click(); // Нажала войти
    ...
    it('Логин без @ и верный пароль', function () {
        ...
        cy.get('#messageHeader').contains('Нужно исправить проблему валидации'); // Проверяю, что мы допустили ошибку валидации
        cy.get('#messageHeader').should('be.visible'); // Текст виден пользователю
        cy.get('#exitMessageButton > .exitIcon').should('be.visible'); // Есть крестик, и он виден для пользователя
    })
